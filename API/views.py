...
from API.serializers import GroupSerializer, UserSerializer, TagSerializer, CategorySerializer, PostSerializer, NewsletterSerializer, ContactSerializer, PostPublishSerializer, CommentSerializer
...
class CommentViewSet(APIView):
    ...
    def post(self, request, post_id, *args, **kwargs):
        request.data.update({"post": post_id, "user": request.user.data})
